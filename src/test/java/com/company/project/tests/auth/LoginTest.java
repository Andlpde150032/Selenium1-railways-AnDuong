...
public class LoginTest extends BaseTest {
    ...
    public void TC08_UserCannotLoginWithUnactivatedAccount() {
        ...
        boolean containsLoginPage = currentUrl.contains("Login.cshtml");
        Assert.assertEquals(containsLoginPage, true, "User should remain on Login page. Current URL: " + currentUrl);
    }
